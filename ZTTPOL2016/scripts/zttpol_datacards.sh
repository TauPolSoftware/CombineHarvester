...
then
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py -i $1 -n 8 -o $2/omegaVisible_2 -c et --categories et_rho -c mt --categories mt_rho -c tt --categories tt_rho --clear-output-dir --use-asimov-dataset --omega-version VisibleSvfit

	# polarisationCombinedOmegaVisibleSvfit (tt)
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py -i $1 -n 8 -o $2/combinedOmegaVisible -c tt --categories tt_combined_rho_rho --clear-output-dir --use-asimov-dataset --omega-version VisibleSvfit
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py -i $1 -n 8 -o $2/best_choice -c em --categories em_combined_oneprong_oneprong -c et --categories et_combined_a1_oneprong et_rho et_combined_oneprong_oneprong -c mt --categories mt_combined_a1_oneprong mt_rho mt_combined_oneprong_oneprong -c tt --categories tt_combined_a1_a1 tt_combined_a1_rho tt_combined_a1_oneprong tt_combined_rho_rho tt_combined_rho_oneprong tt_combined_oneprong_oneprong --clear-output-dir --use-asimov-dataset --fixed-variables
