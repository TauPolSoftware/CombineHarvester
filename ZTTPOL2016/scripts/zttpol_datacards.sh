...
then
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py \
			-i $1 -n 8 -o $2/best_choice_new_new --clear-output-dir --use-asimov-dataset --fixed-variables best_choice \
...
#			--modify-unpolarisation-value -0.2208
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py --old-ztt \
			-i $1 -n 8 -o $2/best_choice_old_new --clear-output-dir --use-asimov-dataset --fixed-variables best_choice \
			-c em --categories em_combined_oneprong_oneprong \
			-c et --categories et_a1 et_rho et_oneprong \
			-c mt --categories mt_rho mt_a1 mt_oneprong \
			-c tt --categories tt_rho tt_combined_a1_a1 tt_combined_a1_oneprong tt_combined_oneprong_oneprong #\
#			--modify-unpolarisation-value -0.2208
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py --old-ztt-asimov \
			-i $1 -n 8 -o $2/best_choice_new_old --clear-output-dir --use-asimov-dataset --fixed-variables best_choice \
			-c em --categories em_combined_oneprong_oneprong \
			-c et --categories et_a1 et_rho et_oneprong \
			-c mt --categories mt_rho mt_a1 mt_oneprong \
			-c tt --categories tt_rho tt_combined_a1_a1 tt_combined_a1_oneprong tt_combined_oneprong_oneprong #\
#			--modify-unpolarisation-value -0.2208
	...
	$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation.py --old-ztt --old-ztt-asimov \
			-i $1 -n 8 -o $2/best_choice_old_old --clear-output-dir --use-asimov-dataset --fixed-variables best_choice \
			-c em --categories em_combined_oneprong_oneprong \
			-c et --categories et_a1 et_rho et_oneprong \
			-c mt --categories mt_rho mt_a1 mt_oneprong \
			-c tt --categories tt_rho tt_combined_a1_a1 tt_combined_a1_oneprong tt_combined_oneprong_oneprong #\
