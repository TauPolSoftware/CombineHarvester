...
class Datacards(object):
	def __init__(self, cb=None):
		...
		self.stable_options = r"--robustFit 1 --preFitValue 1.0 --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo Minuit2  --cminFallbackAlgo Minuit2,0:1.0" #--cminDefaultMinimizerStrategy 0
